$(document).ready(function(){
	...
	// Object literal for Utility Functions
	var fx = {
...
/******** Uncomment the immediate following line to see re-direction among PHP files*********/		
		event.preventDefault();
...
/***************/
	...
	$("body").on("click", "a.admin, .admin-options form",function(event){
